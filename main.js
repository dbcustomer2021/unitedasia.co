...
$.ajax({
    ...
    success: function (data) {
        ...
        for (var r in listdataSlide) {
           ...
           var diva = "<div class='col-md-3'><a href='productdetaail.html?"+id+"'><img src="+qrImage+" height='200px' width='250px'></a><div style='height: 20px'></div><h5>"+qrname+"</h5><div style='height: 20px'></div></div>";
